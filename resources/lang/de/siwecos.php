...
return [
  ...
  'CRIME_VULNERABLE_ERROR_DESC' => "<p>Der Server ist verwundbar durch <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://www.heise.de/security/meldung/Luecke-in-SSL-Verschluesselung-kaum-ausnutzbar-1708371.html\">CRIME</a>. Ein Angriff welcher es einem Angreifer erlaubt die Kommunikation zu entschlüsseln.\n</p>",
  ...
  //
  // HTTPS_NOT_SUPPORTED
  'HTTPS_NOT_SUPPORTED'            => "Überprüfung der Reaktionszeit des <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/HTTPS\" title=\"HTTPS\">HTTPS</a> -Headers\n",
  ...
  //
  // HTTPS_NO_RESPONSE
  'HTTPS_NO_RESPONSE'            => "Überprüfung der Reaktionszeit des <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/Header\" title=\"Header\">Headers</a>\n",
  ...
  //
  // CT_META_TAG_SET
  'CT_META_TAG_SET'            => "Der Header ist korrekt gesetzt und enthält jedoch keine Zeichensatz-Angabe oder folgt nicht den Empfehlungen. Gefunden wurde \"%META%\".\n",
  //
  ...
  'PUBLIC_KEY_PINS_ERROR_DESC' => "<p>Mächtige Angreifer wie bspw. Geheimdienste können ggf. eine <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/Digitale_Signatur\" title=\"Digitale Signatur\">Signatur</a>, mit der Hilfe einer von den Benutzern akzeptierten Zertifizierungsstelle, erstellen lassen. Um dies zu verhindern kann eine Webseite definieren, dass beim ersten Aufruf des Zertifikats das Zertifikat dauerhaft gespeichert (pinning). Mit der Hilfe von Key-Pinning wird für die von der Webseiten definierten Zeit lediglich das gespeicherte Zertifikat akzeptiert.\n</p>",
  ...
  'X_FRAME_OPTIONS_SUCCESS'    => "Der Header ist korrekt gesetzt und verbessert den Schutz Ihrer Webseite gegen <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/Clickjacking\" title=\"Clickjacking\">Clickjacking-Attacken</a>.\n",
  ...
  //
  // JS_LIB
  'JS_LIB'            => "Überprüfung auf <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/JavaScript\" title=\"JavaScript\">JavaScript-Bibliothek</a>\n",
  'JS_LIB_SUCCESS'    => "Die <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/JavaScript\" title=\"JavaScript\">JavaScript-Bibliothek</a> sind nach dem aktuellen Stand nicht durch bekannte Schwachstellen angreifbar.\n",
  ...
  'JS_LIB_ERROR_DESC' => "<p>Es wurde eine von Ihnen verwendete <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/JavaScript\" title=\"JavaScript\">JavaScript-Bibliothek</a> gefunden. Ein Angreifer könnte diese Information nutzen, um gezielt nach Schwachstellen für Ihre Website zu suchen.\n</p>",
  ...
  'CIPHERSUITEORDER_ENFORCED'            => "Überprüfung der Client-<a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/Cipher_Suite\" title=\"Cipher Suite\">Verschlüsselungsmethodik</a>\n",
  ...
  'CIPHERSUITEORDER_ENFORCED_ERROR_DESC' => "<p>Ihr Webserver / Ihre Webseite ist so konfiguriert, dass die <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/Cipher_Suite\" title=\"Cipher Suite\">Verschlüsselungsmethodik</a> des Webseiten-Besuchers bevorzugt wird, statt die Ihres Webservers. Server sollten die Auswahl der Verschlüsselungsmethoden nicht ihren Kunden überlassen, sondern aktiv starke Verbindungen auswählen.\n</p>",
  ...
  //
  // CIPHERSUITE_ANON
  'CIPHERSUITE_ANON'            => "Überprüfung auf anonyme <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/Cipher_Suite\" title=\"Cipher Suite\">Verschlüsselungsmethodik</a>.\n",
  ...
  'CIPHERSUITE_ANON_TIPS'       => "<p>Deaktivieren Sie die Unterstützung des \"Anonymen Schlüsselaustauschs\" in der  <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/Cipher_Suite\" title=\"Cipher Suite\">Verschlüsselungsmethodik</a>. In Konsequenz auf die bekannt gewordenen TLS Schwachstellen ist die wichtigste Regel, wann immer es geht, TLS 1.2 zu nutzen. SSL 3.0 sollte in Browser deaktiviert werden.\n</p>",
  'CIPHERSUITE_ANON_LINK'       => "https://siwecos.de/wiki/Schluesselaustauschverfahren/DE",
  //
  // CIPHERSUITE_DES
  'CIPHERSUITE_DES'            => "Überprüfung auf DES <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/Cipher_Suite\" title=\"Cipher Suite\">Verschlüsselungsmethodik</a>\n",
  'CIPHERSUITE_DES_SUCCESS'    => "Keine veraltete DES <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/Cipher_Suite\" title=\"Cipher Suite\">Verschlüsselungsmethodik</a> unterstützt\n",
  'CIPHERSUITE_DES_ERROR'      => "Veraltete DES <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/Cipher_Suite\" title=\"Cipher Suite\">Verschlüsselungsmethodik</a> unterstützt\n",
  ...
  'CIPHERSUITE_DES_TIPS'       => "<p>Deaktivieren Sie die Unterstützung der DES <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/Cipher_Suite\" title=\"Cipher Suite\">Verschlüsselungsmethodik</a> in Ihrer Webserver-Software.\n</p>",
  ...
  'CIPHERSUITE_NULL_ERROR_DESC' => "<p>Ihr Webserver/ Ihre Webseite ist so konfiguriert, dass zugelassen wird das unverschlüsselt über einen geschützten Kanal gesprochen werden kann. Dies ermöglicht <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/Man-in-the-middle\" title=\"Man-in-the-middle\">Man-in-the-middle Attacken</a>.\n</p>",
  ...
  //
  // CIPHERSUITE_RC4
  'CIPHERSUITE_RC4'            => "Überprüfung auf <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/Rc4_Verschl%C3%BCsselungsmethodik\" title=\"Rc4 Verschlüsselungsmethodik\">RC4 Verschlüsselungsmethodik</a>\n",
  ...
  'CIPHERSUITE_RC4_LINK'       => "https://siwecos.de/wiki/Unsichere-[[Rc4_Verschlüsselungsmethodik|Verschluesselungsfunktion-RC4]]/DE",
  //
  // Category: WS_TLS
  //
  // ANON_SUITES
  'ANON_SUITES'            => "Ihr Webserver/Ihre Webseite ist so konfiguriert, dass eine anonyme <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/Cipher_Suite\" title=\"Cipher Suite\">Verschlüsselungsmethodik</a> ohne Authentikation bei der Verbindung erfolgt. Dies ermöglicht <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/Man-in-the-middle\" title=\"Man-in-the-middle\">Man-in-the-middle Attacken</a>.\n",
  //
  // DES_SUITES
  ...
  //
  // HASH_ALGO
  'HASH_ALGO'            => "Ihr Server-Zertifikat nutzt den schwachen <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/Hashing\" title=\"Hashing\">Hash-Algorithmus</a> %HASH%. Das Zertifikat kann so sehr einfach gefälscht werden. Ein Warnung beim Aufruf Ihrer Webseite erfolgt infolge eines schwachen Hash-Algorithmus jedoch nicht.\n",
  //
  // HTTPS_RESPONSE
  ...
  //
  // RC4_SUITES
  'RC4_SUITES'            => "Ihr Webserver/Ihre Webseite ist so konfiguriert, dass Sie die mittlerweile als unsicher geltende Verschlüsselungsfunktion [[<a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/Rc4_Verschl%C3%BCsselungsmethodik\" title=\"Rc4 Verschlüsselungsmethodik\">RC4 Verschlüsselungsmethodik</a>|RC4]] weiterhin unterstützt. Dies ermöglicht <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/Man-in-the-middle\" title=\"Man-in-the-middle\">Man-in-the-middle Attacken</a>.\n",
  //
  // Category: XSS-Scanner
  //
  // HAS_SINKS
  'HAS_SINKS'            => "Überprüfung des <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/JavaScript\" title=\"JavaScript\">JavaScript</a>-Codes nach <a href=\"/wiki/index.php?title=DOMXSS-Sinks&amp;action=edit&amp;redlink=1\" class=\"new\" title=\"DOMXSS-Sinks (Seite nicht vorhanden)\">DOMXSS-Sinks</a>\n",
  'HAS_SINKS_SUCCESS'    => "Automatisiert wurden keine unsicheren Codebestandteile für <a href=\"/wiki/index.php?title=DOMXSS-Sinks&amp;action=edit&amp;redlink=1\" class=\"new\" title=\"DOMXSS-Sinks (Seite nicht vorhanden)\">DOMXSS-Sinks</a> erkannt.\n",
  'HAS_SINKS_ERROR'      => "Unsicheren <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/JavaScript\" title=\"JavaScript\">JavaScript</a>-Code verwendet (Sinks)\n",
  ...
  //
  // HAS_SOURCES
  'HAS_SOURCES'            => "Überprüfung des <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/JavaScript\" title=\"JavaScript\">JavaScript</a>-Codes nach DOMXSS-Sources\n",
  ...
  'CERTIFICATE_EXPIRED_ERROR_DESC' => "<p>Die Meldung bedeutet, dass Ihr <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/Zertifikate\" title=\"Zertifikate\">Server-Zertifikatt</a> abgelaufen ist. Ihre Webseite wird Besuchern als unsicher bzw. nicht vertrauenswürdig angezeigt wird. Sollte ein Nutzer Ihre Webseite über <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/HTTPS\" title=\"HTTPS\">HTTPS</a> aufrufen, wird ihm möglicherweise eine Fehlermeldung angezeigt, z.B. \"Ihr Zertifikat ist am Datum abgelaufen\". Die Seite wird Besuchern als unsicher bzw. nicht vertrauenswürdig angezeigt.\n</p>",
