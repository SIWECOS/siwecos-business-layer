...
return [
  ...
  //
  // EXPORT_SUITES
  'EXPORT_SUITES'            => "Ihr Webserver/ Ihre Webseite ist so konfiguriert, dass sich vorsätzlich geschwächte kryptographische Funktionen (<a href=\"https://siwecos.de/wiki/Cipher_Suite\" title=\"Cipher Suite\">Cipher Suites</a>) nutzen lassen. Dies ermöglicht <a href=\"/wiki/index.php?title=Man-in-the-Middle&amp;action=edit&amp;redlink=1\" class=\"new\" title=\"Man-in-the-Middle (Seite nicht vorhanden)\">Man-in-the-Middle Attacken</a>.\n",
  //
  // HASH_ALGO
  ...
  //
  // HTTPS_RESPONSE
  'HTTPS_RESPONSE'            => "Der Server “%HOST%“ antwortet nicht auf verschlüsselte HTTP (<a href=\"https://siwecos.de/wiki/HTTPS\" title=\"HTTPS\">HTTPS</a>) Anfragen.\n",
  //
  // HTTPS_SUPPORTED
  ...
  //
  // NULL_SUITES
  'NULL_SUITES'            => "Ihr Webserver/ Ihre Webseite ist so konfiguriert, dass zugelassen wird das unverschlüsselt über einen geschützten Kanal gesprochen werden kann. Dies ermöglicht <a href=\"https://siwecos.de/wiki/Man-in-the-middle\" title=\"Man-in-the-middle\">Man-in-the-Middle Attacken</a>.\n",
  //
  // RC4_SUITES
