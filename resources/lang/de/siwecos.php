...
return [
  ...
  //
  // CMS_ONLY
  'CMS_ONLY'            => 'Das verwendete CMS %cms% wurde detektiert.',
  //
  // CMS_VERSION
  'CMS_VERSION'            => 'Das verwendete CMS %cms% und dessen Version %version% wurde detektiert. Die Angabe einer Version vereinfacht einem Angreifer das Vorbereiten eines Angriffs.',
  //
  // CMS_VERSION_VULN
  'CMS_VERSION_VULN'            => 'Das verwendete CMS %cms% der Version %version% wurde detektiert. Für diese Version ist eine Schwachstelle bekannt.',
  //
  // CSP_CORRECT
  ...
  //
  // HTTPS_SUPPORTED
  'HTTPS_SUPPORTED'            => 'Der Server \\“%HOSTt%\\“ scheint kein TLS zu unterstützen. Dies bedeutet das sie keinerlei Verschlüsselung einsetzen um ihre Daten von ihnen und die ihrer Kunden zu schützen.',
  //
  // INCLUDE_SUBDOMAINS
  'INCLUDE_SUBDOMAINS'            => '`includeSubDomains` ist gesetzt.',
  //
  // JS_LIB_ONLY
  'JS_LIB_ONLY'            => 'Die verwendete JavaScript-Bibliothek %js_lib_name% in DOM-Node %node% mit dem Inhalt %node_content% wurde detektiert.',
  //
  // JS_LIB_VERSION
  'JS_LIB_VERSION'            => 'Die verwendete JavaScript-Bibliothek %js_lib_name% mit der Version %js_lib_version% in DOM-Node %node% mit dem Inhalt %node_content% wurde detektiert. Die Angabe einer Version vereinfacht einem Angreifer das Vorbereiten eines Angriffs.',
  //
  // JS_LIB_VULN_VERSION
  'JS_LIB_VULN_VERSION'            => 'Die verwendete JavaScript-Bibliothek %js_lib_name% mit der Version %js_lib_version% in DOM-Node %node% mit dem Inhalt %node_content% wurde detektiert. Für diese Version ist eine Schwachstelle bekannt.',
  //
  // MAX_AGE_ERROR
  ...
  //
  // PLUGIN_ONLY
  'PLUGIN_ONLY'            => 'Das verwendete CMS-Plugin %plugin% in DOM-Node %node% mit dem Inhalt %node_content% wurde detektiert.',
  //
  // PLUGIN_VERSION
  'PLUGIN_VERSION'            => 'Das verwendete CMS-Plugin %plugin% mit der Version %plugin_version% in DOM-Node %node% mit dem Inhalt %node_content% wurde detektiert. Die Angabe einer Version vereinfacht einem Angreifer das Vorbereiten eines Angriffs.',
  //
  // PLUGIN_VERSION_VULN
  'PLUGIN_VERSION_VULN'            => 'Das verwendete CMS-Plugin %plugin% der Version %plugin_version% in DOM-node %node% mit dem Inhalt %node_content% detektiert. Für diese Version ist eine Schwachstelle bekannt.',
  //
  // RC4_SUITES
  ...
  'POODLE_VULNERABLE_LINK'       => 'https://siwecos.de/wiki/TLS_POODLE_VULNERABLE',
  //
  // SWEET32_VULNERABLE
  ...
  'SWEET32_VULNERABLE_LINK'       => 'https://siwecos.de/wiki/SWEET32-VULNERABLE',
  //
  ...
  'TLS_POODLE_VULNERABLE_LINK'       => 'https://siwecos.de/wiki/TLS-POODLE-VULNERABLE',
  //
  // Category: Generell
  //
  // HTTPS_NOT_SUPPORTED
  ...
  'HTTPS_NOT_SUPPORTED_ERROR_DESC' => 'Der Server scheint kein TLS zu unterstützen. Dies bedeutet das sie keinerlei Verschlüsselung einsetzen um ihre Daten und die ihrer Kunden zu schützen.',
  ...
  'CONTENT_SECURITY_POLICY_ERROR_DESC' => 'Die Content-Security-Policy ist ein Sicherheitskonzept, welches das Injizieren und Auszuführen von evtl. bösartigen Befehlen in eine Webanwendung (Content-Injection-Angriffe) mildern soll. Es stellt über eine Whitelist (Liste erlaubter Quellen) dar, von welchen <a href="https://siwecos.de/wiki/Quellen" target="siwecos_wiki" class="wikI">Quellen</a> Javascripte, Bilder, Schriftarten und andere Inhalte auf Ihrer Seite eingebunden werden dürfen.',
  ...
  'X_CONTENT_TYPE_OPTIONS_ERROR_DESC' => 'Die X-Content-Type-Options Einstellungen im Header verhindern, dass der <a href="https://siwecos.de/wiki/Browser" target="siwecos_wiki" class="wikI">Browser</a> Dateien als etwas anderes interpretiert, als vom Inhaltstyp im <a href="https://siwecos.de/wiki/HTTP" target="siwecos_wiki" class="wikI">HTTP-Header</a> deklariert wurde. Die Headereinstellungen sind hier nicht gesetzt.',
  ...
  'CMS_SUCCESS'    => 'Falls Sie ein CMS verwenden, kann dieses nicht automatisiert detektiert werden.',
  ...
  'CMS_PLUGINS_SUCCESS'    => 'CMS-Plugins können nicht detektiert werden.',
  'CMS_PLUGINS_ERROR'      => 'CMS Plugin detektiert',
  'CMS_PLUGINS_ERROR_DESC' => 'Es wurde in ihrem CMS-System installierte Plugins entdeckt. Ein Angreifer könnte diese Information nutzen um gezielt nach Schwachstellen für ihre Webseite zu nutzen.',
  ...
  'PHONE_NUMBER_LINK'       => 'https://siwecos.de/wiki/Telefonnummer',
  //
  ...
  'CIPHERSUITE_ANON_ERROR_DESC' => 'Ihr Webserver/ Ihre Webseite ist so konfiguriert, dass eine unsichere Verschlüsselungsmethode (<a href="https://siwecos.de/wiki/Cipher Suite" target="siwecos_wiki" class="wikI">Cipher Suite</a>) ohne Rechtekontrolle bei der Verbindung erfolgt. Dies ermöglicht <a href="https://siwecos.de/wiki/Man-in-the-middle" target="siwecos_wiki" class="wikI">Man-in-the-Middle Attacken</a>.',
  ...
  'CIPHERSUITE_NULL_ERROR_DESC' => 'Ihr Webserver/ Ihre Webseite ist so konfiguriert, dass zugelassen wird das unverschlüsselt über einen geschützten Kanal gesprochen werden kann. Dies ermöglicht <a href="https://siwecos.de/wiki/Man-in-the-middle" target="siwecos_wiki" class="wikI">Man-in-the-Middle Attacken</a>.',
  ...
  'CIPHERSUITE_RC4_ERROR_DESC' => 'Ihr Webserver/Ihre Webseite ist so konfiguriert, dass Sie die mittlerweile als unsicher geltende Verschlüsselungsfunktion RC4 (<a href="https://siwecos.de/wiki/Ciper Suite" target="siwecos_wiki" class="wikI">Cipher Suites</a>) weiterhin unterstützt. Dies ermöglicht <a href="https://siwecos.de/wiki/Man-in-the-Middle" target="siwecos_wiki" class="wikI">Man-in-the-Middle Attacken</a>.',
  ...
  'HAS_SINKS_SUCCESS'    => 'Automatisiert wurden keine unsicheren Codebestandteile für DOMXSS-Sinks detektiert.',
  ...
  'HAS_SOURCES_SUCCESS'    => 'Automatisiert wurden keine unsicheren Codebestandteile für DOMXSS-Sources detektiert.',
  ...
  'CERTIFICATE_NOT_SENT_BY_SERVER_ERROR_DESC' => 'Der Server hat kein <a href="https://siwecos.de/wiki/Zertifikate" target="siwecos_wiki" class="wikI">Zertifikat</a> gesendet. Dies ist ungewöhnlich und sollte eigentlich nicht vorkommen. Der Server sollte seine <a href="https://siwecos.de/wiki/Transport_Layer_Security" target="siwecos_wiki" class="wikI">TLS-Konfiguration</a> überprüfen und ggfs. <a href="https://siwecos.de/wiki/CIPHERSUITE_ANON" target="siwecos_wiki" class="wikI">anonyme Ciphersuites</a> ausschalten.',
  ...
  'CERTIFICATE_NOT_VALID_YET_ERROR_DESC' => 'Die Meldung bedeutet, dass Ihr <a href="https://siwecos.de/wiki/Zertifikate" target="siwecos_wiki" class="wikI">Server-Zertifikat</a> noch nicht gültig ist. Ihre Webseite wird Besuchern als unsicher bzw. nicht vertrauenswürdig angezeigt. Sollte ein Nutzer Ihre Webseite über <a href="https://siwecos.de/wiki/HTTPS" target="siwecos_wiki" class="wikI">HTTPS</a> aufrufen, wird ihm möglicherweise eine Fehlermeldung angezeigt.',
  ...
  'CERTIFICATE_WEAK_HASH_FUNCTION_ERROR_DESC' => 'Die Meldung bedeutet, dass Ihr Server-Zertifikat einen schwachen Hash-Algorithmus besitzt. Es stellt möglicherweise ein leichtes Ziel für Hacker-Angriffe dar.',
