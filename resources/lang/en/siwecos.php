...
return [
  ...
  */
  ...
  'CMSVERSION_ERROR_DESC' => "<p>Regular updates, applied in a timely manner, are one of the most effective ways to protect a website. Critical security issues in CMS are often used for automated attacks in just a couple of hours after an update has been released, so staying up-to-date is extremly important.</p>",
  ...
  'SET_COOKIE_ERROR_DESC' => "<p>Cookies should be secured by setting the HttpOnly and Secure flags to ensure they cannot be read or altered by others.</p>",
  'SET_COOKIE_TIPS'       => "<p>`httpOnly`-flag: set this so that cookies cannot be accessed by Javascript. You protect session information from being stolen and misused. Whoever owns a session cookie is authenticated.`secure`-Flag: set this to ensure that cookies are only transmitted across encrypted (https) channels.</p>",
  ...
  'SINKS_TIPS'       => "<p>The check result can only be taken as an indication of security flaws. Further tests are necessary to confirm that there are vulnerabilities on the website.</p>",
  ...
  'SOURCES_ERROR_DESC' => "<p>During the check, at least one vulnerability was found on the web page that could be controlled by an external, potentially untrustworthy source.</p>",
  'SOURCES_TIPS'       => "<p>The check result can only be taken as an indication of security flaws. Further tests are necessary to confirm that there are vulnerabilities on the website.</p>",
  ...
  'TIMEOUT_ERROR_DESC' => "<p>A timeout means that the scan of your domain took longer than usual.</p><p>Some possible reasons are:</p><p>Your server is currently not available, or it is overloaded.</p><p>Our scanner server is currently overloaded.</p>",
  //
  ...
  'X_CONTENT_TYPE_OPTIONS_ERROR_DESC' => "<p>The X-Content-Type-Options settings in the header prevent that the browser interprets data as anything other than declared by the content type in the HTTP header. The header settings are not set here.</p>",
  'X_CONTENT_TYPE_OPTIONS_TIPS'       => "<p>nosniff; <br /><br /><b>Code example of an .htaccess file on an Apache webserver.</b><br /></p><b>--snip</b><pre>&lt;IfModule mod_headers.c&gt;   # prevent mime based attacks like drive-by download attacks, IE and Chrome   '''Header set X-Content-Type-Options \"nosniff\"'''&lt;pre&gt;&lt;/IfModule&gt;</pre><p><b>—snap</b></p><p>Here is an example of an .htaccess file which will set the <b>Header Scanner</b> to green.(<a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/Htaccess/EN\" title=\"Htaccess/EN\">.htaccess example</a>)</p>",
  ...
  'X_XSS_PROTECTION_ERROR_DESC' => "<p>The HTTP header X-XSS-Protection defines how built-in XSS filters in the browser are configured. A default installation can indicate an incorrect configuration.</p>",
  'X_XSS_PROTECTION_TIPS'       => "<p>1; mode=block</p><p><b>Code example of an .htaccess file on an Apache webserver.</b></p><b>--snip</b><br /><pre>   # Turn on XSS prevention tools, activated by default in IE and Chrome   '''Header set X-XSS-Protection \"1; mode=block\"'''</pre><p><b>—snap</b></p><p>Here is an example of an .htaccess file which will set the <b>Header Scanner</b> to green.(<a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/Htaccess/EN\" title=\"Htaccess/EN\">.htaccess example</a>)</p>",
  ...
  'CMS_PLUGINS_TIPS'       => "<p>The use of plug-ins should be limited to those plug-ins that are absolutely necessary. This can reduce the attack surface significantly. In addition, installed plugins should always be kept up to date.</p>",
  ...
  'EMAIL_ADDRESS_TIPS'       => "<p>Enter your contact addresses, for example in the imprint, as follows: mail at siwecos.de / mail @ siwecos.de, or display the information in a graphic file.</p>",
  ...
  'JS_LIB_ERROR_DESC' => "<p>A JavaScript library you are using was detected. An attacker could use this information to search for vulnerabilites on your website.</p>",
  'JS_LIB_TIPS'       => "<p>Update your JavaScript libraries or framework.</p>",
  ...
  'PHONE_NUMBER_ERROR_DESC' => "<p>A phone number was found. An attacker could use this information to manipulate employees and to gain information that should remain secret.</p>",
  'PHONE_NUMBER_TIPS'       => "<p>The published phone numbers should be limited to those which are actually intended for communication with customers. Also, an employee who uses the phone should be aware of the dangers of social engineering attacks and should know the methods of social engineers.</p>",
  ...
  'MALWARE_ERROR_DESC' => "<p>Malware is software that causes damage to the user and to the computer. The term malware is used for all types of malicious programs, such as viruses, trojans, spyware, dialer, dropper, rootkits and keylogger.</p>",
  'MALWARE_TIPS'       => "<p><b><span style=\"color:#c31622\"> Take down the website!<span></b></p><p>If your website is accessed by a user, there is a risk that the user's computer will be infected with malicious software. Taking down the website will also prevent Google from removing your website from its index, which would delete a positive ranking. You also avoid being blocked by your hosting provider.</p><p><b>- Find out how and when it was possible for third parties to access your domain. </b><br /></p><p>Check your logfiles for unauthorized access from unknown <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/IP-Adresse\" title=\"IP-Adresse\">Quell-IP-Adressen</a>. As a starting point for your investigation, the time stamp of the manipulated or uploaded file can give you a hint when the attack happened and by which gateway the attackers gained access.</p><p><b>- Change your login data!</b><br /><b>- Web frontend (hosting contract, <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/Content-Management-Systeme\" title=\"Content-Management-Systeme\">Content-Management-System</a>)</b><br /><b>- <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/FTP\" title=\"FTP\">FTP</a> or <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/SSH\" title=\"SSH\">SSH</a> access</b><br /><b>- <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/Datenbank\" title=\"Datenbank\">Datenbank</a> <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/Starke_Passw%C3%B6rter\" title=\"Starke Passwörter\">Passwörter</a></b><br /></p><p>Restore a malware-free backup!To do this, delete all the files on your webspace. In this way, you will make sure that you do not overlook malicious files from the compromised system which were used as a backdoor by the attackers.Before restoring from the backup, make sure that the intended backup is not yet infected by the malicious code that we detected, and if necessary, use an even older backup.If the backup is malware-free, restore it and then install any updates for your system. Only after this is done, put the website back online.</p><p><b> - If you do not have a backup of your website, consider a completely new installation. Manual cleanups usually take up a lot of time and should only be carried out by qualified experts.</b><br /></p><p>Check your local computer for malicious software! The website <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://www.botfrei.de\">botfrei.de</a> offers helpful information and software.With the EU-Cleaner, you can remove various malicious programs from your computer. (<a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external free\" href=\"https://www.botfrei.de/de/eucleaner/index.html\">https://www.botfrei.de/de/eucleaner/index.html</a>)</span></span></p>",
  ...
  'PHISHING_ERROR_DESC' => "<p><a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external autonumber\" href=\"https://en.wikipedia.org/wiki/Social_engineering_(security)#Phishing\">[1]</a> is a method by which the visitor of a website is tricked into revealing sensitive personal data, such as passwords, credit card numbers, and personal information, to an attacker. Criminals usually start by sending <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/Email_spam\">email spam</a>. These emails contain links to a phishing site that is designed to look like a legitimate website.</p>",
  'PHISHING_TIPS'       => "<p><b><span style=\"color:#c31622\"> Take down the website!<span></b></p><p>There is a risk that your website contains phishing content and that criminals are using it to collect personal data. Taking down the website will also prevent Google from removing your website from its index, which would delete a positive ranking. You also avoid being blocked by your hosting provider.</p><p><b>- Find out how and when it was possible for third parties to access your domain. </b><br /></p><p>Check your logfiles for unauthorized access from unknown IP addresses. As a starting point for your investigation, the time stamp of the manipulated or uploaded file can give you a hint when the attack happened and by which gateway the attackers gained access.</p><p><b>- Change your login data!</b><br /><b>- Web frontend (hosting contract, <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/Content_management_system\">content management system (CMS)</a>)</b><br /><b>- FTP or SSH access</b><br /><b>- Database - use strong passwords</b><br /></p><p>Restore a malware-free backup!To do this, delete all the files on your webspace. In this way, you will make sure that you do not overlook malicious files from the compromised system which were used as a backdoor by the attackers.Before restoring from the backup, make sure that the intended backup is not yet infected by the malicious code that we detected, and if necessary, use an even older backup.If the backup is malware-free, restore it and then install any updates for your system. Only after this is done, put the website back online.</p><p><b> - If you do not have a backup of your website, consider a completely new installation. Manual cleanups usually take up a lot of time and should only be carried out by qualified experts.</b><br /></p><p>Check your local computer for malicious software! The website <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://www.botfrei.de\">botfrei.de</a> offers helpful information and software.With the EU-Cleaner, you can remove various malicious programs from your computer. (<a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external free\" href=\"https://www.botfrei.de/de/eucleaner/index.html\">https://www.botfrei.de/de/eucleaner/index.html</a>)</span></span></p>",
  ...
  'SPAM_ERROR_DESC' => "<p>Spam is unwanted email advertising in your inbox with sometimes dubious content (for example advertisements for viagra, medications, insurance, or credit offers). These advertisements are sent in large quantities, but they can also be targeted specifically. Attackers usually conceal their true identity and try to trick you.</p>",
  'SPAM_TIPS'       => "<p><b><span style=\"color:#c31622\"> Take down the website!<span></b></p><p>Take down your website to prevent users from accessing it, and to prevent Google from removing the website from its index, which would delete a positive ranking. You also avoid being blocked by your hosting provider.</p><p>To check if the website shows any of the typical spam characteristics, call up the website in the browser, then right-click to \"view page source\". In this view, you can use <b>Ctrl+f</b> (search) to check your source code for typical signs of online fraud through advertisements for medications or dubious credit offers.</p><p><b>Some terms to search for</b>:<br />- „payday“<br />- „Pharma“<br />- „Viagra“<br />- „Cialis“<br /><br /><b>- Find out how and when it was possible for third parties to access your domain. </b><br /></p><p>Check your logfiles for unauthorized access from unknown IP addresses. As a starting point for your investigation, the time stamp of the manipulated or uploaded file can give you a hint when the attack happened and by which gateway the attackers gained access.</p><p><b>- Change your login data!</b><br /><b>- Web frontend (hosting contract, <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/Content_management_system\">content management system (CMS)</a>)</b><br /><b>- FTP or SSH access</b><br /><b>- Database - use strong passwords</b><br /></p><p>Restore a malware-free backup!To do this, delete all the files on your webspace. In this way, you will make sure that you do not overlook malicious files from the compromised system which were used as a backdoor by the attackers.Before restoring from the backup, make sure that the intended backup is not yet infected by the malicious code that we detected, and if necessary, use an even older backup.If the backup is malware-free, restore it and then install any updates for your system. Only after this is done, put the website back online.</p><p><b> - If you do not have a backup of your website, consider a completely new installation. Manual cleanups usually take up a lot of time and should only be carried out by qualified experts.</b><br /></p><p>Check your local computer for malicious software! The website <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://www.botfrei.de\">botfrei.de</a> offers helpful information and software.With the EU-Cleaner, you can remove various malicious programs from your computer. (<a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external free\" href=\"https://www.botfrei.de/de/eucleaner/index.html\">https://www.botfrei.de/de/eucleaner/index.html</a>)</span></span></p>",
  ...
  'IRC_ERROR_DESC' => "<p>There port which is commonly used for the \"IRC\" program is active on your server. This program is usually used for a chat server. Criminal often use IRC to control their botnets.</p>",
  'IRC_TIPS'       => "<p>You should switch this service off if you do not require it. If you use IRC, you need not do anything.</p>",
  ...
  'MSSQL_ERROR_DESC' => "<p>A Port is open on Your Server, which is usually used to Operate the MS-SQL Database. This potentially makes it possible to access the Database remotely.</p>",
  'MSSQL_TIPS'       => "<p>In most Cases, it is not wanted to be able to remotely establish a direct Connection to the Database. If this is not intended, you should switch off remote access.</p>",
  ...
  'MYSQL_ERROR_DESC' => "<p>A Port is open on Your Server, which is usually used to Operate the MySQL Database. This potentially makes it possible to access the Database remotely.</p>",
  'MYSQL_TIPS'       => "<p>In most Cases, it is not wanted to be able to remotely establish a direct Connection to the Database. If this is not intended, you should switch off remote access.</p>",
  ...
  'RDP_ERROR_DESC' => "<p>On Your Server, a Port is open, which is usually used for the Protocol \"RDP.\" With RDP, it is possible to remotely control Computers over the Network.</p>",
  'RDP_TIPS'       => "<p>If You don't need this Service, You should simply turn it off as it poses a Security Risk. If they really use RDP, there is nothing to be done.</p>",
  ...
  'TELNET_TIPS'       => "<p>If You don't need this Service, You should simply turn it off as it poses a Security Risk. If so, You should switch to the secure SSH service, which Is used to transmit data encrypted.</p>",
  ...
  'CERTIFICATE_NOT_SENT_BY_SERVER_TIPS'       => "<p>Urgently update your <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/Transport_Layer_Security\">TLS implementation</a>. Current software no longer allows this type of configuration.</p>",
  ...
  'CERTIFICATE_WEAK_HASH_FUNCTION_ERROR_DESC' => "<p>This message means that your <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/Certificate\" title=\"Certificate\">server certificate</a> has a weak hash algorithm (encryption). It may be an easy target for hacker attacks.</p>",
  ...
  'CIPHERSUITEORDER_ENFORCED_ERROR_DESC' => "<p>Your web server/website is configured to give priority to the encryption method selected by the website visitor rather than by your web server. Servers should not allow their clients to select the encryption method, but should actively select strong connections.</p>",
  'CIPHERSUITEORDER_ENFORCED_TIPS'       => "<p>Configure your web server so that the web server selects the encryption method that is used for communication between your website and the visitor's web browser.</p>",
  ...
  'CIPHERSUITE_DES_TIPS'       => "<p>Deactivate support for the DES encryption method in your web server software.</p>",
  ...
  'CIPHERSUITE_EXPORT_TIPS'       => "<p>Deactivate support for EXPORT encryption methods on the web server.</p>",
  ...
  'CIPHERSUITE_NULL_ERROR_DESC' => "<p>Your web server/website is configured to allow unencrypted voice transmission via a secure channel. This makes you vulnerable to <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/Man-in-the-middle_attack\">man-in-the-middle-attacks</a>.</p>",
  'CIPHERSUITE_NULL_TIPS'       => "<p>Deactivate support for NULL encryption methods.</p>",
  ...
  'CIPHERSUITE_RC4_TIPS'       => "<p>Deactivate support for the <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/RC4\">RC4</a> encryption method.</p>",
  ...
  'CRIME_VULNERABLE_ERROR_DESC' => "<p>The server is vulnerable to [<a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external autonumber\" href=\"https://en.wikipedia.org/wiki/CRIME\">[1]</a>]. This allows an attacker to decode the communication.</p>",
  ...
  'HEARTBLEED_VULNERABLE_ERROR_DESC' => "<p>The server is vulnerable to a Heartbleed attack. As a result, an attacker could read sensitive data from the server's working memory, such as private keys and customer data.</p>",
  'HEARTBLEED_VULNERABLE_TIPS'       => "<p>Update your <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/Transport_Layer_Security\">TLS</a> implementation on your server immediately.</p>",
  ...
  'HTTPS_NOT_SUPPORTED_TIPS'       => "<p>Activate <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/Transport_Layer_Security\">TLS</a> (Transport Layer Security)</p>",
  ...
  'HTTPS_NO_RESPONSE_ERROR_DESC' => "<p>The server does not seem to respond. Have you entered the <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/Domain\" title=\"Domain\">Domain</a> correctly?</p>",
  'HTTPS_NO_RESPONSE_TIPS'       => "<p>Please check your input for typing errors.</p>",
  ...
  'INVALID_CURVE_EPHEMERAL_VULNERABLE_TIPS'       => "<p>Update your <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/Transport_Layer_Security\">TLS</a> implementation on your server immediately.</p>",
  ...
  'INVALID_CURVE_VULNERABLE_ERROR_DESC' => "<p>The server is vulnerable to an Invalid Curve attack. This allows an attacker to steal the private key of your <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/Certificate\" title=\"Certificate\">certificate</a>.</p>",
  'INVALID_CURVE_VULNERABLE_TIPS'       => "<p>Update your <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/Transport_Layer_Security\">TLS</a> implementation on your server immediately.</p>",
  ...
  'PADDING_ORACLE_VULNERABLE_ERROR_DESC' => "<p>The server is vulnerable to a <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/Padding_oracle_attack\">Padding Oracle attack</a>, which allows an attacker to decrypt the communication.</p>",
  'PADDING_ORACLE_VULNERABLE_TIPS'       => "<p>Update your <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/Transport_Layer_Security\">TLS</a> implementation on your server immediately.</p>",
  ...
  'POODLE_VULNERABLE_ERROR_DESC' => "<p>The server is vulnerable to a <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/POODLE\">POODLE attack</a>, which allows an attacker to decrypt the communication.</p>",
  'POODLE_VULNERABLE_TIPS'       => "<p>Deactivate the outdated encryption protocol SSL3 on your server immediately!</p>",
  ...
  'PROTOCOLVERSION_SSL2_ERROR_DESC' => "<p>The server supports the outdated protocol version SSL2, which is considered to be highly insecure. By using this version, you massively compromise the security of the server and possibly your entire company network.</p>",
  'PROTOCOLVERSION_SSL2_TIPS'       => "<p><a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/Transport_Layer_Security\">TLS encoding</a> is considered to be the standard today. Therefore you should not use SSL2.</p>",
  ...
  'PROTOCOLVERSION_SSL3_ERROR_DESC' => "<p>The server supports the outdated protocol version SSL3, which is considered to be highly insecure. By using this version, you massively compromise the security of the server and possibly your entire company network.</p>",
  'PROTOCOLVERSION_SSL3_TIPS'       => "<p><a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/Transport_Layer_Security\">TLS</a> encoding is considered to be the standard today. Therefore you should not use SSL3.</p>",
  ...
  'PROTOCOLVERSION_TLS13_TIPS'       => "<p>There is no need for action.</p>",
  ...
  'SWEET32_VULNERABLE_ERROR_DESC' => "<p>The server is vulnerable to <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/Sweet32\">Sweet32</a>, which allows an attacker to decrypt parts of the communication if large amounts of data is transferred via a connection.</p>",
  ...
  'TLS_POODLE_VULNERABLE_TIPS'       => "<p>Update the <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/Transport_Layer_Security\">TLS</a> implementation on your server immediately. In the Apache configuration, you can specify the line \"SSLProtocol All -SSLv2 -SSLv3 \".</p>",
