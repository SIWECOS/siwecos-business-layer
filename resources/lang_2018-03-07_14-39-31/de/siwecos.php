...
return [
  ...
  // Commit . . . .: bc999aeb728525c364cc5d66f7f3ddd0554b69ed
  //
  // Category: Angriffe
  //
  ...
  'BLEICHENBACHER_VULNERABLE_LINK'       => 'BLEICHENBACHER-VULNERABLE',
  //
  // CRIME_VULNERABLE
  ...
  'CRIME_VULNERABLE_LINK'       => 'CRIME-VULNERABLE',
  //
  ...
  'HEARTBLEED_VULNERABLE_LINK'       => 'HEARTBLEED-VULNERABLE',
  //
  ...
  'INVALID_CURVE_EPHEMERAL_VULNERABLE_LINK'       => 'INVALID_CURVE_EPHEMERAL_VULNERABLE',
  //
  ...
  'INVALID_CURVE_VULNERABLE_LINK'       => 'INVALID_CURVE_VULNERABLE',
  //
  ...
  'PADDING_ORACLE_VULNERABLE_LINK'       => 'PADDING_ORACLE_VULNERABLE',
  //
  // POODLE_VULNERABLE
  ...
  'POODLE_VULNERABLE_LINK'       => 'POODLE_VULNERABLE',
  //
  // SWEET32_VULNERABLE
  ...
  'SWEET32_VULNERABLE_LINK'       => 'SWEET32_VULNERABLE',
  //
  ...
  'TLS_POODLE_VULNERABLE_LINK'       => 'TLS_POODLE_VULNERABLE',
  //
  // Category: Generell
  //
  // HTTPS_NOT_SUPPORTED
  ...
  'HTTPS_NOT_SUPPORTED_LINK'       => 'HTTPS_NOT_SUPPORTED',
  //
  // HTTPS_NO_RESPONSE
  ...
  'HTTPS_NO_RESPONSE_LINK'       => 'HTTPS_NO_RESPONSE',
  //
  // SCORE_bonus
  'SCORE_bonus'            => 'Bonus',
  //
  ...
  'SCORE_info_LINK'       => 'HTTPS_NO_RESPONSE',
  //
  // SCORE_success
  ...
  'CONTENT_SECURITY_POLICY_LINK'       => 'Content-Security-Policy',
  //
  // CONTENT_TYPE
  ...
  'CONTENT_TYPE_LINK'       => 'Content-Type',
  //
  // JS_LIB
  ...
  'PUBLIC_KEY_PINS_LINK'       => 'Public-Key-Pins',
  //
  ...
  'STRICT_TRANSPORT_SECURITY_LINK'       => 'Strict-Transport-Security',
  //
  ...
  'X_CONTENT_TYPE_OPTIONS_LINK'       => 'X-Content-Type-Options',
  //
  // X_FRAME_OPTIONS
  ...
  'X_FRAME_OPTIONS_LINK'       => 'X-Frame-Options',
  //
  // X_XSS_PROTECTION
  ...
  'X_XSS_PROTECTION_LINK'       => 'X-Xss-Protection',
  //
  ...
  'MALWARE_ERROR_DESC' => 'Malware bezeichnet Software, die dem Benutzer und natürlich in erster Linie seinem Computer Schaden zufügen kann. Malware bezeichnet dabei alle Arten von schadhaften Programmen wie etwa Viren, Trojanern, Spyware, Dialer, Dropper, Rootkits und Keylogger',
  'MALWARE_LINK'       => 'Malware-Inhalte',
  //
  // PHISHING
  ...
  'PHISHING_LINK'       => 'Phishing-Inhalte',
  //
  // SPAM
  ...
  'PROTOCOLVERSION_SSL2_LINK'       => 'PROTOCOLVERSION_SSL2',
  //
  ...
  'PROTOCOLVERSION_SSL3_LINK'       => 'PROTOCOLVERSION_SSL3',
  //
  ...
  'PROTOCOLVERSION_TLS13_LINK'       => 'PROTOCOLVERSION_TLS13',
  //
  // Category: Scanner
  //
  // SCANNER_NAME_DOMXSS
  ...
  'CIPHERSUITEORDER_ENFORCED_LINK'       => 'CIPHERSUITEORDER_ENFORCED',
  //
  // CIPHERSUITE_ANON
  ...
  'CIPHERSUITE_ANON_LINK'       => 'CIPHERSUITE_ANON',
  //
  // CIPHERSUITE_DES
  ...
  'CIPHERSUITE_DES_LINK'       => 'CIPHERSUITE_DES',
  //
  // CIPHERSUITE_EXPORT
  ...
  'CIPHERSUITE_EXPORT_LINK'       => 'CIPHERSUITE_EXPORT',
  //
  // CIPHERSUITE_NULL
  ...
  'CIPHERSUITE_NULL_LINK'       => 'CIPHERSUITE_NULL',
  //
  // CIPHERSUITE_RC4
  ...
  'CIPHERSUITE_RC4_LINK'       => 'CIPHERSUITE_RC4',
  //
  ...
  'CERTIFICATE_EXPIRED_LINK'       => 'CERTIFICATE_EXPIRED',
  //
  ...
  'CERTIFICATE_NOT_SENT_BY_SERVER_LINK'       => 'CERTIFICATE_NOT_SENT_BY_SERVER',
  //
  ...
  'CERTIFICATE_NOT_VALID_YET_LINK'       => 'CERTIFICATE_NOT_VALID_YET',
  //
  ...
  'CERTIFICATE_WEAK_HASH_FUNCTION_LINK'       => 'CERTIFICATE_WEAK_HASH_FUNCTION',
  //
